...
if($id > 0) {	
	...
	$model->updateCateArticles($id,$cate_name,$cate_alias,$image_url,$description,$meta_title,$meta_description,$meta_keyword,$is_hot,$hidden);

	header('location:'.$url);

}else{

	$model->insertCateArticles($cate_name,$cate_alias,$image_url,$description,$meta_title,$meta_description,$meta_keyword,$is_hot,$hidden);

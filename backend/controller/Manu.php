...
if($id > 0) {	
	...
	$model->updateManu($id,$manu_name,$manu_alias,$description,$image_url,$is_hot,$display_order,$meta_title,$meta_description,$meta_keyword,$hidden);

	header('location:'.$url);

}else{

	$model->insertManu($manu_name,$manu_alias,$description,$image_url,$is_hot,$display_order,$meta_title,$meta_description,$meta_keyword,$hidden);

    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6">
            ...
            <div class="box-header">
                ...
                <h3 class="box-title"><?php echo (isset($id) && $id> 0) ? "Cập nhật" : "Tạo mới" ?> thương hiệu <?php echo (isset($id) && $id> 0) ? " : ".$data['manu_name'] : ""; ?></h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12" >
                            ...
                            <div class="form-group">                                
                                ...
                                <label style="color:red">Thương hiệu HOT</label>
                            </div>
                            <div class="form-group">                                
        ...
        <div class="col-md-12 nav-tabs-custom">
            ...
            <div class="button">
                ...
                <button class="btn btn-primary" type="button" onclick="location.href='index.php?mod=manu&act=list'">Cancel</button>
            </div>
